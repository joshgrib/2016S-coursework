...
public:
    ...
    void insert(const iterator &it, const std::pair<K, V> &key_value) {
        ...
        // TODO
        //Assume x and y are initialized, then follow book code
        if( (key == key_value.first) || (y==NULL) ){//placeholder because otherwise 'key' isnt used
        	y = NULL;
        }
    }
...
private:
    ...
    int diameter(Node<K, V> *node) const {
        // TODO
    	//recursively call diameter and height function
    	return 0;//placeholder
    }
